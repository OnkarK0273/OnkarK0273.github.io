            ...
            <VStack w='280px' m='auto' border={'0px'} alignItems={'center'} pb='10px'>
                <VStack   alignItems={'flex-start'} >
                    ...
                    <HStack columnGap={'10px'}>
                        ...
                        <Text  fontWeight={'bold'}>onkarok0273.1@gmail.com</Text>
                    </HStack>
                </VStack>
            </VStack>
            <Box  m='auto'p='10px'>
                <Flex border={'0px'}  justifyContent='space-between' alignItems={'center'} flexDirection={{base:'column',md:'row'}} >
                        ...
                        <Flex border={'0px'}  justifyContent='space-around' alignItems={'center'} w='30%' >
                            ...
                            <IconButton onClick={()=>{document.location.href='https://github.com/OnkarK0273' }} bg='#C7AE92' size={'lg'} icon={<Icon as={AiFillGithub} boxSize={8} />} />
                            ...
                            <IconButton onClick={()=>{ document.location.href='https://www.linkedin.com/in/onkar-k-557a421a4/'}} bg='#C7AE92' size={'lg'} icon={<Icon as={AiFillLinkedin} boxSize={8} />} />
                        </Flex>
